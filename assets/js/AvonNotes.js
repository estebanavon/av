...
var data4 = [
    [
		...
		{
			title: 'Prueba de Color Centro',
			file: 'PruebaDeColorCentro.pdf',
			type: 'flyer',
		},
		{
			title: 'Prueba de Color Noreste',
			file: 'PruebaDeColorNoreste.pdf',
			type: 'flyer',
		},
		{
			title: 'Prueba de Color Norte',
			file: 'PruebaDeColorNorte.pdf',
			type: 'flyer',
		},
		{
			title: 'Prueba de Color Sur',
			file: 'PruebaDeColorSur.pdf',
			type: 'flyer',
		},
    ],
    [
...
var data20 = [
    ...
    var avNcmBoolean,brochuresWrapper,masterHtml,brochuresConstructor;
    avNcmBoolean = 0;
    ...
    function urlFile(type,file){
        ...
        switch (type){
            case "contigo":
                urlFile = 'https://'+ avEnviorment + '.' + avMarket.toLowerCase() +'.avon.com/FLDSuite/static/pdf/incentivos2019/' + file
                break
            case "youtube":
                urlFile = file
                break
            default:
                urlFile = 'https://'+ avEnviorment + '.' + avMarket.toLowerCase() +'.avon.com/FLDSuite/static/pdf/mis_folletos/' + file
        }
        return urlFile
    }
    ...
    switch(site){
        case 'REPSuite':
            vendorlink = '<a class="av-button-secondary" href="/REPSuite/vendorLinksOne.page?linkid=42" style="width:85%;margin:60px auto 0px auto;">Tablero de control</a>'
            break
        case 'SLSuite':
            vendorlink = '<a class="av-button-secondary" href="/SLSuite/vendorLinksOne.page?linkid=45" style="width:85%;margin:60px auto 0px auto;">Tablero de control</a>'
            break
        default:
            vendorlink = ''
    }
    ...
    masterHtml = '<section class="av-lw"><aside id="brochureAside" style="box-shadow:none;" class="av-brochure-aside">'+ vendorlink +''+
    ...
    '<i class="fab fa-whatsapp" aria-hidden="true"></i></a></div></div></aside><section class="av-section-container expand"><h2 class="av-brochure-title" style="line-height: 38px;"><span class="av-title-stroke">Materiales</span> descargables</h2><div class="av-filtros" style="top: 50px;"><label style="font-family: montserrat-bold, Arial Black, Gadget, sans-serif;"><i class="fas fa-filter"></i> Filtrar por: </label>'+
...
$(document).ready(function(){
    ...
    $('#viewMore').click(function(){
        $('#brochureList').css('display','flex').prepend('<h3 class="w-100 av-brochures-subtitle" style="padding-left: 10px; margin-top:10px;"><i class="far fa-calendar-check"></i> Campaña '+ brochurePrint[5] +'</h3>');
