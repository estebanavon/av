...
window.onload = function(){
  ...
  '<div class="av-card-image"><img class="w-100 av-fallback" src="/SLSuite/static/images/sinergia/img/C09c_sinergia.jpg" alt="Descargables"></div>'+
  ...
  document.getElementById('sinergiaBox').innerHTML +=
  '<div class="col"><a href="/SLSuite/static/pdf/sinergia/sinergia_c10'+ slPrint +'.pdf" target="_blank" class="av-card-link"><div class="av-card">'+
  '<div class="av-card-image"><img class="w-100 av-fallback" src="/SLSuite/static/images/sinergia/img/C10c_sinergia.jpg" alt="Descargables"></div>'+
