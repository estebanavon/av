...
const generalToolsSection = [
    ...
    },
    {
        ...
        file: 'Planograma_Actualizado_2020.pdf',
    },
    {
        name: 'Guía de Referencia',
        file: 'GUIA_DE_REFERENCIA_2018-FINAL.pdf',
    },
    {
        name: 'Acuerdo PM',
...
const prospectionSection = [
    ...
    {
        name: 'Lona Tenacidad',
        file: 'lona_liderazgo_TENACIDAD.jpg',
    },
    {
        name: 'Lona Independencia, 150cms x 100cms',
        file: 'lona_liderazgo_independencia.tif',
    },
    {
...
while (e < avConstructor.length){
    for (i = 0; i < avConstructor[e].length; i++) {
        avArrayPrintContent[e] += '<li>' +
            ...
            '<a class="av-button-icon av-tooltip" href="/SLSuite/static/liderazgo_2020/' + avConstructor[e][i].file + '" target="_blank"><span class="material-icons">visibility</span><span class="tooltiptext">Previsualizar</span></a>' +
            '<a class="av-button-icon av-tooltip" href="/SLSuite/static/liderazgo_2020/' + avConstructor[e][i].file + '" download><span class="material-icons">cloud_download</span><span class="tooltiptext">Descargar</span></a>'+
            '</li>';
    }
    e++    
}
