...
function pdfImg(type,canvasIdNumber,file){
	...
	if(type == 'youtube') {
		...
		avCanvasLet = '<div class="av-canvas-container"><canvas width="162" class="av-canvas" id="avCanvas'+ canvasIdNumber +'"></canvas></div>'
