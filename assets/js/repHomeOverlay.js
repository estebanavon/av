...
// Asignar a false si se quiere descativar el modal
...
if (avModalSwitch){
    ...
    var avModalhtml = '<div id="avOverlay" class="av-modal">'+
                ...
                '<h2 class="tbl_header_big" style="margin-bottom:10px;">Bienvenida</h2><h2 class="tbl_header_big" id="avModalName"></h2></div>'+
