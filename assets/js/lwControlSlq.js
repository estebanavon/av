const imssSection = [
    ...
    {
        name: 'Flyer IMSS Periodo C 2020',
        file: 'Flyer_IMSS_Periodo_C_2020.pdf',
    },
    {
        name: 'IMSS C9 a C13',
        file: 'IMSS_C9-C13.pdf',
    },
];
...
const modelPropsSection = [
    {
        name:'Sin documentos por el momento',
        file: ''
    },
];
const celayaSection = [
...
var avConstructor = [generalToolsSection,messagesToolsSection,prospectionSection,seasonPropsSection,celayaSection,modelPropsSection,videosSection,imssSection,vacationsSection];
