$(document).ready(function(){
        ...
        switch (type){
            case "imb":
                if (campaignSelector(e) <= 9 && file <= 9) {
                    ...
                    urlFile = 'https://catalogo.avon.com.'+ avMarket.toLowerCase() +'/0'+ campaignSelector(e) +'/20'+ otherYear(e) +'0'+ campaignSelector(e) + '_' + file +'/#/'
                } else if (campaignSelector(e) > 9 && file > 9){
                    urlFile = 'https://catalogo.avon.com.'+ avMarket.toLowerCase() +'/'+ campaignSelector(e) +'/20'+ otherYear(e) +''+ campaignSelector(e) + '_' + file +'/#/'
                }
                break
            case "contigo":
    ...
    brochurePrint[3] += '<div class="av-brochure-item av-brochure-main" data-type="'+ brochuresConstructor[0][0].type +'">'+
                            '<div style="background-image:url(\'/FLDSuite/static/images/mis_folletos/IMB'+ brochuresConstructor[0][0].file +'-cover-c'+ currentCampaign +'.jpg\')" class="av-brochure-image">' +
