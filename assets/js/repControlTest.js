...
$(document).ready(function () {
    ...
    const avRepAcct = AvonAnalyticsObjex.Profile.repAcct; 
    const avNumber = AvonAnalyticsObjex.Profile.loa; 
    //const avNumber = '0'; 
  
  
    var avBooleanCE = false;
    if(avRepCeNewGen.includes(avRepAcct)) {
      avBooleanCE = true;
    }
    
    if (avBooleanCE){
      let newPhrase,newImg;
      switch(avNumber){
        case '0':
        case '1':
          newPhrase = 'Recuerda que para participar debes acumular $3,000 pesos entre la 1ª y la 2ª campaña y mantenerte activa en la 3a.';
          newImg = '';
          break
        case '2':
          newPhrase = 'Recibe la 1ª pieza de tu Brazalete: la pulsera.';
          newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_pulsera.jpg" style="width:50%;margin:0 auto;display: block;" />';
          break
        case '3':
          newPhrase = 'Además recibe el charm Fortaleza.';
          newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_fortaleza.jpg" style="width:50%;" />';
          $('.av-ce-obk').children().eq(1).append('<p class="av-text mt-3"><b class="av-highlight">Acumula $6,000 de tu'+
            ' cuarta sexta campaña</b> para ganar juego de sábanas y cobertor matrimonial</p><img src="/FLDSuite/static/'+
            'images/circulo_estelar/ce_cobertor.jpg" style="width:100%;margin:0 auto;display: block;" /><small class="mt-2">Recibe tus regalos en'+
            ' tu séptima Campaña</small>');
          break
        case '4':
          newPhrase = 'Además recibe el charm Compromiso.';
          newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_compromiso.jpg" style="width:50%;" />';
          break
        case '5':
          newPhrase = 'Además recibe el charm Persistencia.';
          newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_persistencia.jpg" style="width:50%;" />';
          break
        case '6':
            newPhrase = 'Recibe el Juego de sábanas y cobertor si acumulaste $6,000 pesos precio de referencia entre tu 4ª y tu 6ª campaña';
            newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_cobertor.jpg" style="width:100%;margin:0 auto;display: block;" />';
          break
        case '7':
            newPhrase = 'Además recibe el charm Determinación.';
            newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_determinacion.jpg" style="width:50%;" />';
            $('.av-ce-obk').children().eq(1).append('<p class="av-text mt-3"><b class="av-highlight">Agregar “Acumula $14,000 de tu cuarta '+
            'a décima campaña</b> para ganar 1 Edredón blanco + 2 fundas doble vista tamaño matrimonial”</p><img src="/FLDSuite/static/'+
            'images/circulo_estelar/ce_cobertor2.jpg" style="width:75%;margin:0 auto;display: block;" /><small>Recibe tus regalos en'+
            ' tu onceava Campaña</small>');
          break
        case '8':
            newPhrase = 'Además recibe el charm Libertad.';
            newImg = '<img src="/FLDSuite/static/images/circulo_estelar/ce_determinacion.jpg" style="width:50%;" />';
          break
          default:
            newPhrase = 'Recuerda que para participar debes acumular $3,000 pesos entre la 1ª y la 2ª campaña y mantenerte activa en la 3a.';
      }
      $('.av-ce-obk').children().eq(0).children().eq(6).append('<p class="av-text mt-3"><b class="av-highlight">'+ newPhrase +'</b></p>'+ newImg );
      avFiles0[0].file = 'Circulo_Estelar_3.0_Nuevas_V.pdf';
      avFiles0[4].file = 'Guia_bienvenida_V.pdf';
      avFiles1[4].file = 'Circulo_Estelar_3.0_Nuevas_V.pdf';
      avFiles6[0].file = 'Circulo_Estelar_3.0_Nuevas_V.pdf';
    }
